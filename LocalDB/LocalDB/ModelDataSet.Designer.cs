...
namespace LocalDB {
    ...
    public partial class ModelDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomersRow AddCustomersRow(string Fullname, string Email, string Password, string TC, string Date_of_birth, string Phone, bool Gender) {
        ...
        public partial class CustomersRow : global::System.Data.DataRow {
            ...
            public string Date_of_birth {
                get {
                    try {
                        return ((string)(this[this.tableCustomers.Date_of_birthColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Date of birth\' in table \'Customers\' is DBNull.", e);
                    }
                }
                set {
...
namespace LocalDB.ModelDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customers] WHERE (([Id] = @Original_Id) AND ((@IsNull_Fullname = 1 AND [Fullname] IS NULL) OR ([Fullname] = @Original_Fullname)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_TC = 1 AND [TC] IS NULL) OR ([TC] = @Original_TC)) AND ((@IsNull_Date_of_birth = 1 AND [Date of birth] IS NULL) OR ([Date of birth] = @Original_Date_of_birth)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customers] ([Id], [Fullname], [Email], [Password], [TC], [Date of birth], [Phone], [Gender]) VALUES (@Id, @Fullname, @Email, @Password, @TC, @Date_of_birth, @Phone, @Gender);
SELECT Id, Fullname, Email, Password, TC, [Date of birth], Phone, Gender FROM Customers WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [Id] = @Id, [Fullname] = @Fullname, [Email] = @Email, [Password] = @Password, [TC] = @TC, [Date of birth] = @Date_of_birth, [Phone] = @Phone, [Gender] = @Gender WHERE (([Id] = @Original_Id) AND ((@IsNull_Fullname = 1 AND [Fullname] IS NULL) OR ([Fullname] = @Original_Fullname)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_TC = 1 AND [TC] IS NULL) OR ([TC] = @Original_TC)) AND ((@IsNull_Date_of_birth = 1 AND [Date of birth] IS NULL) OR ([Date of birth] = @Original_Date_of_birth)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)));
SELECT Id, Fullname, Email, Password, TC, [Date of birth], Phone, Gender FROM Customers WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Fullname, Email, Password, TC, [Date of birth], Phone, Gender FROM dbo" +
                ".Customers";
        ...
        public virtual int Delete(int Original_Id, string Original_Fullname, string Original_Email, string Original_Password, string Original_TC, string Original_Date_of_birth, string Original_Phone, global::System.Nullable<bool> Original_Gender) {
        ...
        public virtual int Insert(int Id, string Fullname, string Email, string Password, string TC, string Date_of_birth, string Phone, global::System.Nullable<bool> Gender) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Fullname, string Email, string Password, string TC, string Date_of_birth, string Phone, global::System.Nullable<bool> Gender, int Original_Id, string Original_Fullname, string Original_Email, string Original_Password, string Original_TC, string Original_Date_of_birth, string Original_Phone, global::System.Nullable<bool> Original_Gender) {
            return this.Update(Original_Id, Fullname, Email, Password, TC, Date_of_birth, Phone, Gender, Original_Id, Original_Fullname, Original_Email, Original_Password, Original_TC, Original_Date_of_birth, Original_Phone, Original_Gender);
        }
    }
